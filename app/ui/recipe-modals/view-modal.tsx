          ...
          <div className="md:overflow-y-scroll flex flex-col items-center w-full px-4 pt-4 pb-4">
            ...
            >
              ...
              <div className="flex gap-2 md:gap-4 items-center">
                {/* share recipe if is pulbic */}
                {viewData?.is_public && (
                  <ShareModal
                    id={viewData?.id as string}
                    isPublic={viewData?.is_public}
                    publicLink={viewData.publicLink as string}
                  />
                )}
                <div
                  onClick={closeViewModal}
                  className="cursor-pointer size-8 rounded-full bg-white/10 shadow-[inset_10px_-50px_94px_0_rgb(199,199,199,0.2)] backdrop-blur flex justify-center items-center "
                >
                  <Image
                    src="/icons/close.svg"
                    width={16}
              ...
              <div className="w-full">
                ...
                <div className="flex gap-2 items-center">
                  {viewData?.tags.map((tag: string, index: number) => (
                    <p key={index} className="text-sm font-sans text-gray-500 ">
                      {tag}
                    </p>
                  ))}
                </div>
